...
COMMODITY_CATALOG: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "notes": "PBS SPI Item 6 - Mutton average retail across 17 urban centres.",
        "what_changed": "Mutton edged up by PKR 10.00 (+0.54% WoW).",
        "why_it_matters": "Premium household protein; steady rates help keep weekly dining and family banquet costs predictable.",
        "financial_impact_hint": "For families buying 2-3 kg/month, this adds ~PKR 25-30 monthly.",
    },
    # Food & Staples
    {
        "id": "wheat_flour_bag",
    ...
    },
    {
        ...
        "notes": "PBS SPI Item 1a - Standard 10 kg wheat flour bag.",
    ...
    {
        "id": "pulse_chana",
        "name": "Pulse Chana (Gram)",
        "normalized_name": "daal_chana",
        "category": "Pulses",
        "unit": "1 kg",
        "price": 285.00,
        "previous_price": 282.50,
        "notes": "PBS SPI Item 19 - Split brown gram pulse.",
        "what_changed": "Pulse Chana gained PKR 2.50 (+0.88% WoW).",
        "why_it_matters": "High-protein staple consumed across all economic tiers.",
        "financial_impact_hint": "Minor weekly budget impact for basic rations.",
    },
    # Cooking & Fuel
    {
        "id": "cooking_oil",
    ...
    },
    {
        ...
        "unit": "1 Litre",
        "price": 268.50,
        "previous_price": 266.14,
        "notes": "PBS SPI Item 30 - National regulated retail pump price.",
        "what_changed": "Petrol increased by PKR 2.36 (+0.89% WoW).",
    ...
    },
    {
        ...
        "notes": "PBS SPI Item 31 - National regulated retail pump price.",
        "what_changed": "High-Speed Diesel rose by PKR 3.00 (+1.10% WoW).",
        "why_it_matters": "Critical driver for public transit fares, freight trucking, and agricultural tractor operations.",
        "financial_impact_hint": "Directly raises logistics costs across supply chains and intercity bus fares.",
    },
    {
        "id": "lpg_cylinder",
        "name": "LPG Domestic Cylinder",
        "normalized_name": "lpg",
        "category": "Cooking & Fuel",
        "unit": "11.8 kg Cylinder",
        "price": 2980.00,
        "previous_price": 2993.50,
        "notes": "PBS SPI Item 32 - Standard 11.8 kg domestic cylinder.",
        "what_changed": "LPG cylinder eased by PKR 13.50 (-0.45% WoW).",
        "why_it_matters": "Primary cooking fuel in areas without pipeline natural gas connections.",
        "financial_impact_hint": "Slight relief for households relying on cylinder refills every 4-6 weeks.",
    },
)
